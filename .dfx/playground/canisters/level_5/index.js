...
import { idlFactory } from './level_5.did.js';
export { idlFactory } from './level_5.did.js';
// CANISTER_ID is replaced by webpack based on node environment
export const canisterId = process.env.LEVEL_5_CANISTER_ID;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./level_5.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the level_5 canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./level_5.did.js")._SERVICE>}
 */
export const level_5 = createActor(canisterId);
