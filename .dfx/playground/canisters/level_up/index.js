...
import { idlFactory } from './level_up.did.js';
export { idlFactory } from './level_up.did.js';
// CANISTER_ID is replaced by webpack based on node environment
export const canisterId = process.env.LEVEL_UP_CANISTER_ID;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./level_up.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the level_up canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./level_up.did.js")._SERVICE>}
 */
export const level_up = createActor(canisterId);
